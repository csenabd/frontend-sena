...
function DetailPageSem() {
  ...
  useEffect(() => {
    axios
      .get(`${URL.API}/api/v1/ProyectoSem/${id}`)
      .then((res) => {
  ...
  const sendCorreo = () => {
    axios
      .post(`${URL.API}/api/v1/ProyectoSem/${id}/send-code`)
  ...
  const deleteProyecto = () => {
    axios
      .delete(`${URL.API}/api/v1/ProyectoSem/${id}?confirmationCode=${codigo}`)
      .then((res) => {
        console.log(res);
  ...
  const handleObjetivoChange = (objetivoId, checked) => {
    axios
      .put(
        `${URL.API}/api/v1/ProyectoSem/${id}/objetivo-especifico/${objetivoId}`,
        { finalizado: checked },
        {
          headers: {
...
const handleActividadChange = (objetivoId, actividadId, checked) => {
  ...
  axios
    .put(
      `${URL.API}/api/v1/ProyectoSem/${id}/objetivo/${objetivoId}/actividad/${actividadId}`,
